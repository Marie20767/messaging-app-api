...
const insertMessageThreadsMessages = `
  ...
  VALUES
    ...
    (1, 1, $1, 'I''m talking about earlier. I went into the girl''s bathroom just before I came in here and there were about 
    a dozen girls in there, including that Romilda Vane trying to decide how to slip you a love potion. 
    They''re all hoping they''re going to get you to take them to Slughorn''s party.', NOW() - interval '17 minutes'),
    (1, $1, 1, 'Why didn''t you confiscate them then?', NOW() - interval '15 minutes'),
    (1, 1, $1, 'They didn''t have the potions with them in the bathroom. They were just discussing tactics.
    ...
    It''s tomorrow night, they''re getting desperate.', NOW() - interval '11 minutes'),
    ...
    (2, 2, $1, 'Is it true? Did you break into Gringotts? Did you escape on a dragon? It''s everywhere, everyone''s talking about it, 
    Terry Boot got beaten up by Carrow for yelling about it in the Great Hall at dinner!', NOW() - interval '28 minutes'),
    ...
    (2, 2, $1, 'But what have you been doing? People have been saying you''ve just been on the run but I don''t think so. 
    I think you''ve been up to something', NOW() - interval '22 minutes'),
    ...
    (2, 2, $1, 'The other teachers are all supposed to refer us to the Carrows if we do anything wrong. They don''t, though, if they can avoid it. You can tell they all hate them as much as we do.', NOW() - interval '15 minutes'),
    (2, 2, $1, 'Amycus, the bloke, he teaches what used to be Defense Against the Dark Arts, except now it''s just the Dark Arts. We''re supposed 
    to practice the Cruciatus Curse on people who''ve earned detentions.', NOW() - interval '14 minutes'),
    ...
    yeh wouldn'' fit in at Hogwarts, remember? Not sure yeh were really up to it...an'' now look at yeh!', NOW() - interval '537 minutes'),
    ...
    (7, 7, $1, 'Voldemort uses people his enemies are close to. He''s already used you as bait once, and that was just 
    because you''re my best friend''s sister. Think how much danger you''ll be in if we keep this up. He''ll know, 
    he''ll find out. He''ll try and get to me through you.', NOW() - interval '747 minutes'),
    ...
    (7, $1, 7, 'I never really gave up on you...Not really. I always hoped...Hermione told me to get on with life, 
