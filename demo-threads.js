...
const insertMessageThreadsMessages = `
  ...
  VALUES
    ...
    (2, 2, 'I am what I am, an'' I''m not ashamed. Never be ashamed my ol'' dad used ter say, there''s some who''ll hold it 
    against you, but they''re not worth botherin'' with. An'' he was right. I''ve bin an idiot. I''m not botherin'' with 
    her no more, I promise yeh that. Big bones...I''ll give her big bones.', CURRENT_DATE - interval '31 minutes'),
    (2, 2, 'Yeh know wha? When I firs'' met you, you reminded me o'' me a bit. Mum an'' Dad gone an'' you was feelin'' like 
    yeh wouldn'' fit in at Hogwarts, remember? Not sure yeh were really up to it...an'' now look at yeh!', CURRENT_DATE - interval '27 minutes'),
    (2, 2, 'How you doin'' with that egg?', CURRENT_DATE - interval '23 minutes'),
    (2, $1, 'Great. Really great.', CURRENT_DATE - interval '21 minutes'),
    (2, 2, 'You show em''! Beat ''em all!', CURRENT_DATE - interval '14 minutes'),

    (3, 3, 'So tell me. Your scar...has it been hurting at all?', CURRENT_DATE - interval '61 minutes'),
    (3, $1, 'No and I''ve been wondering about that. I thought it would be burning all the time now Voldemort''s getting so powerful again.', CURRENT_DATE - interval '59 minutes'),
    (3, 3, 'I on the other hand thought otherwise. Lord Voldemort has finally realized the dangerous access to his thoughts and feelings 
    you have been enjoying. It appears that he is now employing Occlumency against you.', CURRENT_DATE - interval '32 minutes'),
    (3, $1, 'Well I''m not complaining.', CURRENT_DATE - interval '18 minutes'),

    (4, 4, 'I suppose I''m just going to have to accept that he really is going to marry her.', CURRENT_DATE - interval '202 minutes'),
    ...
    (4, 4, 'I haven''t been sleeping that well since...well...I could do with some sleep.', CURRENT_DATE - interval '182 minutes'),
    ...
    (6, 6, 'I knew you''d come back! I knew it!', CURRENT_DATE - interval '10 hours'),
    (6, $1, 'How???', CURRENT_DATE - interval '552 minutes'),
    (6, 6, 'I knew you''d come! Kept telling Seamus it was a matter of time!', CURRENT_DATE - interval '548 minutes'),
    (6, 6, 'Is it true? Did you break into Gringotts? Did you escape on a dragon? It''s everywhere, everyone''s talking about it, 
    Terry Boot got beaten up by Carrow for yelling about it in the Great Hall at dinner!', CURRENT_DATE - interval '546 minutes'),
    (6, $1, 'Yeah, it''s true.', CURRENT_DATE - interval '535 minutes'),
    (6, 6, 'What did you do with the dragon?', CURRENT_DATE - interval '533 minutes'),
    (6, $1, 'Released it into the wild. Hermione was all for keeping it as a pet.', CURRENT_DATE - interval '530 minutes'),
    (6, 6, 'But what have you been doing? People have been saying you''ve just been on the run but I don''t think so. 
    I think you''ve been up to something', CURRENT_DATE - interval '528 minutes'),
    (6, $1, 'You''re right but tell us about Hogwarts, Neville, we haven''t heard anything.', CURRENT_DATE - interval '526 minutes'),
    (6, 6, 'It''s been....Well, it''s not really like Hogwarts anymore...Do you know about the Carrows?', CURRENT_DATE - interval '523 minutes'),
    (6, $1, 'Those 2 Death Eaters who teach here?', CURRENT_DATE - interval '522 minutes'),
    (6, 6, 'They do more than teach...', CURRENT_DATE - interval '521 minutes'),
    (6, 6, 'They''re in charge of all discipline. They like punishment the Carrows.', CURRENT_DATE - interval '520 minutes'),
    (6, $1, 'Like Umbridge?', CURRENT_DATE - interval '519 minutes'),
    (6, 6, 'Nah, they make her look tame. The other teachers are all supposed to refer us to the Carrows if we do anything wrong. 
    They don''t, though, if they can avoid it. You can tell they all hate them as much as we do.', CURRENT_DATE - interval '516 minutes'),
    (6, 6, 'Amycus, the bloke, he teaches what used to be Defense Against the Dark Arts, except now it''s just the Dark Arts. We''re supposed 
    to practice the Cruciatus Curse on people who''ve earned detentions.', CURRENT_DATE - interval '513 minutes'),
    (6, $1, 'What???', CURRENT_DATE - interval '512 minutes'),
    (6, 6, 'Yeah...I''ll tell you all about it later when we''re upstairs.', CURRENT_DATE - interval '511 minutes'),
    ...
    (9, 9, 'We''ll be there', CURRENT_DATE - interval '1 day'),
    (9, $1, 'What?', CURRENT_DATE - interval '23 hours'),
    (9, 9, 'At your aunt and uncle''s house. And then we''ll go with you, wherever you''re going', CURRENT_DATE - interval '1363 minutes'),
    (9, $1, 'No!', CURRENT_DATE - interval '1360 minutes'),
    (9, 9, 'Hermione and I are with you whatever happens.', CURRENT_DATE - interval '1359 minutes'),
    (9, 9, 'But mate you''re going to have to come round my mum and dad''s house before we do anything else, even Godric''s Hollow.', CURRENT_DATE - interval '1350 minutes'),
    (9, $1, 'Why?', CURRENT_DATE - interval '1324 minutes'),
    (9, 9, 'Bill and Fleur''s wedding remember?', CURRENT_DATE - interval '1290 minutes'),
    (9, $1, 'Yeah, we shouldn''t miss that!', CURRENT_DATE - interval '1280 minutes'),
    ...
    (10, $1, 'Time''s running out...Voldemort''s getting nearer Professor, I''m acting on Dumbledore''s orders. I must find what he wanted me to find! 
    But we''ve got to get the students out while I''m searching the castle. It''s me Voldemort wants, but he won''t care about killing a few more or 
    less, not now. Not now he knows I''m attacking Horcruxes...', CURRENT_DATE - interval '2832 minutes'),
    ...
    (10, 10, 'Come. We must alert the other Heads of House. You''d better bring your Cloak.', CURRENT_DATE - interval '2831 minutes');
`;
