...
const insertMessageThreadsMessages = `
  ...
  VALUES
    (1, 1, $1, 'Viktor Krum is not even good-looking!', NOW() - interval '3 days 13 hours 5 minutes'),
    (1, 1, $1, 'Those girls only like him because he''s famous!', NOW() - interval '3 days 13 hours 3 minutes'),
    (1, 1, $1, 'They wouldn''t look twice at him if he couldn''t do that WonkyFaint thing', NOW() - interval '3 days 13 hours 3 minutes'),
    (1, $1, 1, 'Wronski Feint!', NOW() - interval '3 days 12 hours 48 minutes'),
    (1, $1, 1, 'What about Ron, though?', NOW() - interval '3 days 12 hours 19 minutes'),
    (1, $1, 1, 'Don''t you want to go with him to Hogsmeade?', NOW() - interval '3 days 12 hours 18 minutes'),
    (1, 1, $1, 'Oh well...', NOW() - interval '3 days 12 hours 3 minutes'),
    (1, 1, $1, 'I thought we might meet up with him in the Three Broomsticks...', NOW() - interval '3 days 12 hours 2 minutes'),
    (1, $1, 1, 'No!', NOW() - interval '3 days 11 hours 53 minutes'),
    (1, 1, $1, 'Oh this is so stupid', NOW() - interval '3 days 11 hours 43 minutes'),
    (1, $1, 1, 'I''ll come but I''m not meeting Ron', NOW() - interval '3 days 11 hours 34 minutes'),
    (1, $1, 1, 'And I''m wearing my Invisibility Cloak.', NOW() - interval '3 days 11 hours 33 minutes'),
    (1, 1, $1, 'Oh all right then...', NOW() - interval '3 days 11 hours 27 minutes'),
    (1, 1, $1, 'I hate talking to you in that cloak. I never know if I''m looking at you or not.', NOW() - interval '3 days 11 hours 18 minutes'),
    (1, $1, 1, 'I didn''t start this.', NOW() - interval '1 day'),
    (1, 1, $1, 'You miss him!', NOW() - interval '23 hours 10 minutes'),
    (1, 1, $1, 'And I know he misses you...', NOW() - interval '23 hours 3 minutes'),
    (1, $1, 1, 'Miss him?', NOW() - interval '22 hours 54 minutes'),
    (1, $1, 1, 'I don''t miss him...', NOW() - interval '22 hours 54 minutes'),
    ...
    (1, 1, $1, 'Well, just be careful what you drink, because Romilda Vane looked like she meant business.', NOW() - interval '1 minutes'),
    ...
    (3, $1, 3, 'What''s up?', NOW() - interval '10 days 16 hours 12 minutes'),
    (3, 3, $1, 'Did you know?', NOW() - interval '10 days 16 hours 4 minutes'),
    (3, 3, $1, 'About Hagrid being half-giant?', NOW() - interval '10 days 16 hours 4 minutes'),
    (3, $1, 3, 'No. So what?', NOW() - interval '10 days 16 hours 2 minutes'),
    (3, $1, 3, 'What''s the problem with giants?', NOW() - interval '10 days 15 hours 52 minutes'),
    (3, 3, $1, 'Well...They''re not very nice', NOW() - interval '10 days 15 hours 44 minutes'),
    (3, $1, 3, 'Who cares?', NOW() - interval '10 days 15 hours 41 minutes'),
    (3, $1, 3, 'There''s nothing wrong with Hagrid!', NOW() - interval '10 days 15 hours 40 minutes'),
    (3, 3, $1, 'I know there isn''t but blimey...no wonder he keeps it quiet', NOW() - interval '10 days 15 hours 32 minutes'),
    (3, 3, $1, 'I always thought he''d got in the way of a bad Engorgement Charm when he was a kid or something...', NOW() - interval '10 days 15 hours 30 minutes'),
    (3, $1, 3, 'But what''s it matter if his mother was a giantess?', NOW() - interval '10 days 15 hours 25 minutes'),
    (3, 3, $1, 'Well...no one who knows him will care because they''ll know he''s not dangerous', NOW() - interval '10 days 15 hours 21 minutes'),
    (3, 3, $1, 'But they''re just vicious, giants. It''s like Hagrid said. It''s in their natures, they''re like trolls...', NOW() - interval '10 days 15 hours 20 minutes'),
    (3, 3, $1, 'They just like killing, everyone knows that. There aren''t any left in Britain now though.', NOW() - interval '10 days 15 hours 17 minutes'),
    (3, $1, 3, 'What happened to them?', NOW() - interval '10 days 15 hours 13 minutes'),
    (3, 3, $1, 'Well they were dying out anyway and then loads got themselves killed by Aurors.', NOW() - interval '10 days 15 hours 9 minutes'),
    (3, 3, $1, 'There are supposed to be giants abroad though...They hide out in mountains mostly...', NOW() - interval '10 days 15 hours 6 minutes'),
    ...
    (4, 4, $1, 'You''d think people had better things to gossip about than your tattoos', NOW() - interval '12 days 10 hours 5 minutes'),
    (4, $1, 4, 'What did you tell her?', NOW() - interval '12 days 9 hours 45 minutes'),
    (4, 4, $1, 'I told her it''s a Hungarian Horntail tattoo', NOW() - interval '12 days 9 hours 40 minutes'),
    (4, 4, $1, 'Much more macho', NOW() - interval '12 days 9 hours 40 minutes'),
    (4, $1, 4, 'Thanks haha', NOW() - interval '12 days 9 hours 37 minutes'),
    (4, $1, 4, 'And what did you tell her Ron''s got?', NOW() - interval '12 days 9 hours 35 minutes'),
    (4, 4, $1, 'A Pygmy Puff, but I didn''t say where.', NOW() - interval '12 days 9 hours 30 minutes'),
    (4, $1, 4, 'Haha don''t tell him that!', NOW() - interval '12 days 9 hours 29 minutes'),
    ...
    (5, 5, $1, 'You know what this means?', NOW() - interval '16 days 2 hours 10 minutes'),
    (5, 5, $1, 'Turning Pettigrew in?', NOW() - interval '16 days 2 hours 10 minutes'),
    (5, $1, 5, 'You''re free...', NOW() - interval '16 days 2 hours 3 minutes'),
    (5, 5, $1, 'Yes...But I''m also...I don''t know if anyone ever told you this', NOW() - interval '16 days 1 hours 55 minutes'),
    (5, 5, $1, 'I''m your godfather', NOW() - interval '16 days 1 hours 54 minutes'),
    (5, $1, 5, 'Yeah I knew that', NOW() - interval '16 days 1 hours 50 minutes'),
    (5, 5, $1, 'Well...your parents appointed me your guardian', NOW() - interval '16 days 1 hours 47 minutes'),
    (5, 5, $1, 'If anything happened to them...', NOW() - interval '16 days 1 hours 47 minutes'),
    (5, 5, $1, 'I''ll understand of course if you want to stay with your aunt and uncle. But...', NOW() - interval '16 days 1 hours 46 minutes'),
    (5, 5, $1, 'Think about it...Once my name''s cleared...if you wanted a different home...', NOW() - interval '16 days 1 hours 46 minutes'),
    (5, $1, 5, 'What? Live with you? Leave the Dursleys?', NOW() - interval '16 days 1 hours 43 minutes'),
    (5, 5, $1, 'Of course I thought you wouldn''t want to. I understand.', NOW() - interval '16 days 1 hours 41 minutes'),
    (5, $1, 5, 'Are you insane?', NOW() - interval '16 days 1 hours 40 minutes'),
    (5, $1, 5, 'Of course I want to leave the Dursleys! Have you got a house? When can I move in?', NOW() - interval '16 days 1 hours 40 minutes'),
    (5, 5, $1, 'You want to??? You mean it?', NOW() - interval '16 days 1 hours 37 minutes'),
    (5, $1, 5, 'Yeah I mean it!', NOW() - interval '16 days 1 hours 34 minutes'),
    ...
    (6, 6, $1, '''Spect it''s a record. Don'' reckon they''ve ever had a teacher who lasted on''y a day before.', NOW() - interval '21 days 20 hours 2 minutes'),
    (6, $1, 6, 'You haven''t been fired Hagrid!', NOW() - interval '21 days 18 hours 49 minutes'),
    (6, 6, $1, 'Not yet but''s only a matter o'' time. I''n''t after Malfoy...', NOW() - interval '21 days 18 hours 29 minutes'),
    (6, $1, 6, 'How is he? It wasn''t serious was it?', NOW() - interval '21 days 18 hours 22 minutes'),
    (6, 6, $1, 'Madam Pomfrey fixed him best she could', NOW() - interval '21 days 18 hours 20 minutes'),
    (6, 6, $1, 'But he''s sayin'' it''s still agony...covered in bandages...moanin''', NOW() - interval '21 days 18 hours 19 minutes'),
    (6, $1, 6, 'He''s faking it. Madam Pomfrey can mend anything', NOW() - interval '21 days 18 hours 14 minutes'),
    (6, $1, 6, 'She regrew half my bones last year. Trust Malfoy to milk it for all it''s worth.', NOW() - interval '21 days 18 hours 13 minutes'),
    (6, 6, $1, 'School gov''nors have bin told o'' course', NOW() - interval '21 days 18 hours 11 minutes'),
    (6, 6, $1, 'They reckon I started too big. Shoulda left Hippogriffs fer later...one flobberworms or summat...', NOW() - interval '21 days 18 hours 10 minutes'),
    (6, 6, $1, 'Jus'' thought it''d make a good firs'' lesson...s'' all my fault', NOW() - interval '21 days 18 hours 9 minutes'),
    (6, $1, 6, 'It''s all Malfoy''s fault Hagrid!', NOW() - interval '21 days 18 hours 7 minutes'),
    (6, $1, 6, 'We''re all witnesses. You said Hippogriffs attack if you insult them.', NOW() - interval '21 days 18 hours 7 minutes'),
    (6, $1, 6, 'It''s Malfoy''s problem that he wasn''t listening. We''ll tell Dumbledore what really happened', NOW() - interval '21 days 18 hours 7 minutes'),
    (6, 6, $1, 'Thanks...', NOW() - interval '21 days 18 hours 2 minutes'),
    ...
    (8, 8, $1, 'Ron can laugh. But my father has done a lot of research on Gernumbli magic.', NOW() - interval '31 days 18 hours 12 minutes'),
    (8, $1, 8, 'Really? Are you sure you don''t want to put anything on your bite though?', NOW() - interval '31 days 18 hours 7 minutes'),
    (8, 8, $1, 'Oh it''s fine...', NOW() - interval '31 days 18 hours 3 minutes'),
    (8, 8, $1, 'You look smart', NOW() - interval '17 days 23 hours 13 minutes'),
    (8, 8, $1, 'I told Daddy most people would probably wear dress robes, but he believes you ought to wear sun colors to a wedding', NOW() - interval '17 days 23 hours 12 minutes'),
    (8, 8, $1, 'For luck you know', NOW() - interval '17 days 23 hours 12 minutes'),
    (8, $1, 8, 'Is it alright if I join you later?', NOW() - interval '17 days 22 hours 53 minutes'),
    (8, 8, $1, 'Oh yes!', NOW() - interval '17 days 22 hours 50 minutes'),
    (8, 8, $1, 'Daddy''s just gone to give Bill and Fleur our present.', NOW() - interval '17 days 22 hours 47 minutes'),
    ...
    (9, $1, 9, 'Ron and I will go get our stuff...', NOW() - interval '90 days 22 hours 15 minutes'),
    (9, 9, $1, 'What are you talking about?', NOW() - interval '90 days 21 hours 42 minutes'),
    (9, $1, 9, 'Well you''re expelling us aren''t you?', NOW() - interval '90 days 21 hours 42 minutes'),
    (9, 9, $1, 'Not today', NOW() - interval '90 days 21 hours 28 minutes'),
    (9, 9, $1, 'But I must impress upon both of you the seriousness of what you have done.', NOW() - interval '90 days 21 hours 26 minutes'),
    (9, 9, $1, 'I will be writing to both your families tonight. I must also warn you that if you do anything like this again...', NOW() - interval '90 days 21 hours 26 minutes'),
    (9, 9, $1, 'I will have no choice but to expel you', NOW() - interval '90 days 21 hours 26 minutes'),
    (9, $1, 9, 'Professor, when we took the car term hadn''t started, so...Gryffindor shouldn''t really have points taken from it should it?', NOW() - interval '90 days 21 hours 22 minutes'),
    (9, 9, $1, 'I will not take any points from Gryffindor', NOW() - interval '90 days 21 hours 12 minutes'),
    (9, 9, $1, 'But you will both get a detention', NOW() - interval '90 days 21 hours 11 minutes'),
    (9, $1, 9, 'Professor! Your bird! I couldn''t do anything...he just caught fire', NOW() - interval '44 days 22 hours 51 minutes'),
    (9, 9, $1, 'About time too. He''s been looking dreadful for days. I''ve been telling him to get a move on.', NOW() - interval '44 days 22 hours 32 minutes'),
    (9, 9, $1, 'Fawkes is a phoenix. Phoenixes burst into flame when it''s time for them to die', NOW() - interval '44 days 22 hours 27 minutes'),
    (9, 9, $1, 'They are reborn from the ashes. You can come watch him later', NOW() - interval '44 days 22 hours 27 minutes'),
    (9, 9, $1, 'It''s a shame you had to see him on a Burning Day.', NOW() - interval '44 days 22 hours 24 minutes'),
    (9, 9, $1, 'He''s really very handsome most of the time, wonderful red and gold plumage. Fascinating creatures...', NOW() - interval '44 days 22 hours 24 minutes'),
    (9, 9, $1, 'I do not think you attacked those people by the way', NOW() - interval '44 days 22 hours 20 minutes'),
    (9, $1, 9, 'Oh good...', NOW() - interval '44 days 22 hours 16 minutes'),
